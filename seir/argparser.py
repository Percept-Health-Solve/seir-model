"""
Dataclass argument parser taken from the HuggingFace HfArgumentParser. This code has been made available under the
Apache License 2.0.

Source: https://github.com/huggingface/transformers/blob/master/src/transformers/hf_argparser.py

Credit to julien-c, LysandreJik, jplu, and BramVanroy for contributing to the development of the parser.
"""
